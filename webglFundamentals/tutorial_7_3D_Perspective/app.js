...
function Init(){
    ...
    matrix = m4.perspective(fieldOfViewInRadians, aspect, zNear, zFar);
    matrix = m4.translate(matrix, translation[0], translation[1], translation[2]);
    matrix = m4.xRotate(matrix, radToDeg(0));
    matrix = m4.yRotate(matrix, radToDeg(20));
    matrix = m4.xRotate(matrix, radToDeg(180));
